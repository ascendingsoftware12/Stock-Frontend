...
//   const [isDropdownEy1Open, setIsDropdownEy1Open] = useState(false);
//   const [isDropdownEZ1Open, setIsDropdownEZ1Open] = useState(false);
//   const [isDropdownEZ2Open, setIsDropdownEZ2Open] = useState(false);
...
//   const toggleDropdownEy1 = () => setIsDropdownEy1Open(!isDropdownEy1Open);
//   const toggleDropdownEZ1 = () => setIsDropdownEZ1Open(!isDropdownEZ1Open);
//   const toggleDropdownEZ2 = () => setIsDropdownEZ2Open(!isDropdownEZ2Open);
...
//         </div>
//         {isDropdownOpen2 && (
//           <div className="absolute right-0 mt-2 w-35 bg-white rounded-md shadow-lg dark:bg-gray-700">
//             <button
//               className="flex items-center w-full px-4 py-2 text-gray-800 dark:text-white hover:bg-blue-700 dark:hover:bg-gray-600"
...
//                     className="flex items-center w-full p-2 text-base  text-slate-100 transition duration-75 rounded-lg group hover:bg-blue-700  dark:text-white dark:hover:bg-gray-700"
//                     aria-controls="dropdown-example"
//                     data-collapse-toggle="dropdown-ey1"
//                     onClick={toggleDropdownEZ2}
//                   >
//                     <FaBoxOpen className="w-5 h-5 text-lightblue-custom transition duration-75 dark:text-gray-400 group-hover:text-slate-100 dark:group-hover:text-white" />
...
//                     className="flex items-center w-full p-2 text-base  text-slate-100 transition duration-75 rounded-lg group hover:bg-blue-700  dark:text-white dark:hover:bg-gray-700"
//                     aria-controls="dropdown-example"
//                     data-collapse-toggle="dropdown-ey2"
//                     onClick={toggleDropdownEZ1}
//                   >
//                     <FaBoxOpen className="w-5 h-5 text-lightblue-custom transition duration-75 dark:text-gray-400 group-hover:text-slate-100 dark:group-hover:text-white" />
